...
void tambah_jadwal(){
    ...
    jumlah_dokter++;
    char ulangi;
    cout << "Ketik 'y' Untuk Lanjut Menambahkan Jadwal: ";
    cin >> ulangi;
    ...
    switch (pilih) {
      case '1':
        ...
        while (coba < 3) {
          ...
          if (userlogin == username && password == passlogin) {
          ...
          if (coba == 3) {
            cout << "Login Melewati Batas Percobaan" << endl
                 << "Program Di Hentikan";
            exit(0);
          }
        }
...
void menu(){
    ...
    while (true){  
        ...
        cout << "Jumlah dokter yang terdaftar: " << hitungJumlahDokter() << endl;
