...
void tambahJadwal() {
    if (jumlahJadwal < MAX_JADWAL) {
        cout << "Nama Dokter: ";
        getline(cin, jadwalDokterList[jumlahJadwal].nama);
        cout << "Spesialis: ";
        getline(cin, jadwalDokterList[jumlahJadwal].spesialis);
        cout << "Jam Mulai: ";
        getline(cin, jadwalDokterList[jumlahJadwal].jamPraktek.mulai);
        cout << "Jam Selesai: ";
        getline(cin, jadwalDokterList[jumlahJadwal].jamPraktek.selesai);
        jumlahJadwal++;
